...
interface IProps {
  subDepartmentList: any[] | undefined;
  handleDeleteSubDepartment: (id: string) => void;
  page: number;
  ...
  loading: boolean;
  handleEditSubDepartment: (subDepartment: any) => void;
}
          ...
          >
            ...
            <TableBody>
              {loading ? (
                ...
                subDepartmentList.map((subDepartment: any, index: number) => (
                  <TableRow key={index} hover sx={{
                    ...
                    <TableCell sx={{ textAlign: 'center' }} >
                      ...
                      <IconButton
                        color="error"
                        onClick={() => handleDeleteSubDepartment(subDepartment.sub_department_id)}
                        size="small"
                      >
                        <IconTrash size={18} />
                      </IconButton>
...
export default memo(SubDepartmentTable);
